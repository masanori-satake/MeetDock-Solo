...
[![Version](https://img.shields.io/badge/version-v1.12.0-blue.svg)](package.json)
...
2. 最新のリリース（`v1.12.0` など）の **Assets** セクションから、`.vsix` ファイル（例: `meetdock-solo-1.12.0.vsix`）をクリックしてダウンロードします。
