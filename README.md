...
[![Version](https://img.shields.io/badge/version-v1.14.6-blue.svg)](package.json)
...
2. 最新のリリース（`v1.14.6` など）の **Assets** セクションから、`.vsix` ファイル（例: `meetdock-solo-1.14.6.vsix`）をクリックしてダウンロードします。
