...
[![Version](https://img.shields.io/badge/version-v1.13.3-blue.svg)](package.json)
...
2. 最新のリリース（`v1.13.3` など）の **Assets** セクションから、`.vsix` ファイル（例: `meetdock-solo-1.13.3.vsix`）をクリックしてダウンロードします。
